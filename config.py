...
FILE_DIR = "doc/"
prompt_template = """You are a personal Bot assistant for answering any questions about documents of dell manuals.
...
"""
k = 3  # number of chunks to consider when generating answer
